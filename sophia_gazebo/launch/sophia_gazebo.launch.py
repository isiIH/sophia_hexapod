...
def generate_launch_description():
    ...
    package_name_gazebo = 'sophia_gazebo'
    package_name_description = 'sophia_description'
    package_name_controller = 'sophia_controller'

    default_robot_name = 'sophia_spider'
    ...
    pkg_share_controller = FindPackageShare(
        package=package_name_controller).find(package_name_controller)
